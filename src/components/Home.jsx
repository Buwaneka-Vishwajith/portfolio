...
const MiniTerminal = () => {
  ...
  return (
    <motion.div
      className={`bg-gray-900 rounded-lg shadow-2xl overflow-hidden font-mono text-xs transition-all duration-300 ${
        isExpanded ? "w-120" : "w-120"
      }`}
    ...
    >
      ...
      <div className="bg-gray-800 px-3 py-2 flex items-center justify-center relative">
        <div className="flex space-x-1.5 absolute left-3">
          <button
            ...
            className="w-2.5 h-2.5 bg-purple-400 rounded-full hover:bg-red-400 transition-colors"
          ></button>
      ...
      <div className="bg-gray-800 px-3 py-1 text-xs text-gray-400/60 flex justify-center">
        <span>Surely this terminal does more than just sit here... right?</span>
      </div>
    </motion.div>
  );
};
